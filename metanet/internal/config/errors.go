...
var (
	// ErrInvalidNetwork indicates the network name is not "mainnet" or "testnet".
	...
	// ErrInvalidRPCAddr indicates the RPC address is malformed.
	ErrInvalidRPCAddr = errors.New("config: invalid RPC address")

	// ErrInvalidMaxPeers indicates MaxPeers is out of acceptable range.
	ErrInvalidMaxPeers = errors.New("config: invalid max peers (must be 0-1000)")
