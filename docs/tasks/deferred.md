...
1. **x402 → payment** — 新包名确定为 `payment`。全面替换：libbitfs-go/x402/→payment/、libbitfs-ts/src/x402/→payment/、bitfs/internal/daemon/、bitfs/internal/engine/、docs/design/、docs/specs/bitfs/08-x402.md、docs/whitepaper/、websites/。
